                ...
                <div>
                    ...
                    <fieldset>
                        <legend>
                            ...
                            <button onClick={() => setStoolTypeModalIsOpen(true)} aria-label="Open Bristol Stool Scale Details" title="Bristol Stool Scale Details">?</button>
                        </legend>
                        {
                            stoolTypes.map(stoolType => {
                                return (
                ...
                <div>
                    ...
                    <fieldset>
                        <legend>
                            ...
                            <button onClick={() => setColorModalIsOpen(true)} aria-label="Open Color Details" title="Color Details">?</button>
                        </legend>
                        {
                            colors.map(color => {
                                return (
                ...
                <div>
                    ...
                    <fieldset>
                        <legend>
                            ...
                            <button onClick={() => setSymptomModalIsOpen(true)} aria-label="Open Symptom Details" title="Symptom Details">?</button>
                        </legend>
                        {
                            symptoms.map(symptom => {
                                return (
