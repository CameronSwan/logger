...
const TermsOfService = () => {
    ...
    return (
        <div className='outside-spacing'>
            <h1 className='underlined'>TERMS OF SERVICE</h1>
            <p>Last updated: March 10, 2023 </p>
            <h2>AGREEMENT TO OUR LEGAL TERMS</h2>
            <p>
                We are NSCC Poop Logger ("Company," "we," "us," "our"), a company
                registered in Canada at 5685 Leeds St, Halifax, Nova Scotia B3K 4M2. We
                operate the mobile application Poop Logger (the "App"), as well as any
                other related products and services that refer or link to these legal
                terms (the "Legal Terms") (collectively, the "Services").
            </p>
            <p>
                You can contact us by phone at 9024035575, email at w0455841@nscc.ca, or
                by mail to 5685 Leeds St, Halifax, Nova Scotia B3K 4M2, Canada.
            </p>
            <p>
                These Legal Terms constitute a legally binding agreement made between
                you, whether personally or on behalf of an entity ("you"), and NSCC Poop
                Logger, concerning your access to and use of the Services. You agree
            ...
            <p>
                ...
                upon posting or notifying you by w0455841@nscc.ca, as stated in the
            ...
            <ol>
                <li>
                    <Link to="#1">OUR SERVICES</Link>
                </li>
                <li>
                    <Link to="#2">INTELLECTUAL PROPERTY RIGHTS</Link>
                </li>
                <li>
                    <Link to="#3">USER REPRESENTATIONS</Link>
                </li>
                <li>
                    <Link to="#4">USER REGISTRATION</Link>
                </li>
                <li>
                    <Link to="#5">PROHIBITED ACTIVITIES </Link>
                </li>
                <li>
                    <Link to="#6">USER GENERATED CONTRIBUTIONS</Link>
                </li>
                <li>
                    <Link to="#6">CONTRIBUTION LICENSE</Link>
                </li>
                <li>
                    <Link to="#6">GUIDELINES FOR REVIEWS</Link>
                </li>
                <li>
                    <Link to="#6">MOBILE APPLICATION LICENSE</Link>
                </li>
                <li>
                    <Link to="#6">SERVICES MANAGEMENT</Link>
                </li>
                <li>
                    <Link to="#7">PRIVACY POLICY</Link>
                </li>
                <li>
                    <Link to="#8">1COPYRIGHT INFRINGEMENTS</Link>
                </li>
                <li>
                    <Link to="#9">TERM AND TERMINATION</Link>
                </li>
                <li>
                    <Link to="#10">MODIFICATIONS AND INTERRUPTIONS </Link>
                </li>
                <li>
                    <Link to="#11">GOVERNING LAW</Link>
                </li>
                <li>
                    <Link to="#12">DISPUTE RESOLUTION </Link>
                </li>
                <li>
                    <Link to="#13">CORRECTIONS </Link>
                </li>
                <li>
                    <Link to="#14">DISCLAIMER</Link>
                </li>
                <li>
                    <Link to="#15">LIMITATIONS OF LIABILITY</Link>
                </li>
                <li>
                    <Link to="#16">INDEMNIFICATION</Link>
                </li>
                <li>
                    <Link to="#17">USER DATA </Link>
                </li>
                <li>
                    <Link to="#18">
                ...
                <li>
                    <Link to="#19">CALIFORNIA USERS AND RESIDENTS</Link>
                </li>
                <li>
                    <Link to="#20">MISCELLANEOUS</Link>
                </li>
                <li>
                    <Link to="#21">CONTACT US</Link>
                </li>
            </ol>
            ...
            <h2 id="2" className='bottom-spacing'>2. INTELLECTUAL PROPERTY RIGHTS</h2>
            ...
            <p>
                ...
                our Legal Terms, please address your request to: w0455841@nscc.ca. If we
            ...
            <p>
                ...
                and through any media channels. </p><p>
            ...
            <h2 id="4">4. USER REGISTRATION</h2>
            ...
            <h2 id="5">5. PROHIBITED ACTIVITIES</h2>
            ...
            <h2 id="6">6. USER GENERATED CONTRIBUTIONS</h2>
            ...
            <h2 id="7">7. CONTRIBUTION LICENSE</h2>
            ...
            <h2 id="8">GUIDELINES FOR REVIEWS</h2>
            <p>
                We may provide you areas on the Services to leave reviews or ratings.
                When posting a review, you must comply with the following criteria: (1)
                you should have firsthand experience with the person/entity being
            ...
            <h2 id="10">10. SERVICES MANAGEMENT </h2>
            <p>
            ...
            <p>
                ...
                data transferred to and processed in Canada. Further, we do not
            ...
            <h2 id="12">12. COPYRIGHT INFRINGEMENTS</h2>
            <p>
                We respect the intellectual property rights of others. If you believe
                that any material available on or through the Services infringes upon
            ...
            <h2 id="13">13. TERM AND TERMINATION</h2>
            <p>
                ...
                ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION. </p><p>
            ...
            <h2 id="14">MODIFICATIONS AND INTERRUPTIONS </h2>
            <p>
            ...
            <h2 id="15">GOVERNING LAW</h2>
            <p>
                These Legal Terms shall be governed by and defined following the laws of
                Canada. NSCC Poop Logger and yourself irrevocably consent that the
            ...
            <h2 id="16">16. DISPUTE RESOLUTION</h2>
            ...
            <p>
                ...
                be three (3). The seat, or legal place, or arbitration shall be Halifax,
                Canada. The language of the proceedings shall be English. The governing
            ...
            <h2 id="19">19. LIMITATIONS OF LIABILITY</h2>
            <p>
            ...
            <h2 id="20">20. INDEMNIFICATION</h2>
            <p>
            ...
            <h2 id="23">23. CALIFORNIA USERS AND RESIDENTS</h2>
            <p>
            ...
            <p>
                NSCC Poop Logger<br />
                5685 Leeds St<br />
                Halifax, Nova Scotia B3K 4M2<br />
                Canada<br />
                Phone: +9024035575<br />
                Email: w0455841@nscc.cache
            </p>
            <p>
