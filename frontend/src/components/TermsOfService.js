...
const TermsOfService = () => {
    ...
    <div>
        ...
        <p>
            ...
            <li>
                and download or print a copy of any portion of the Content to
        ...
        <p>
            ...
            your request to: w0455841@nscc.ca. If we ever grant you the permission
        ...
        <p>
            ...
            be treated as a Contribution. <br />
        ...
        <p>
          ...
          your data transferred to and processed in Canada. Further, we do not
          ...
          consent, we will delete that information from the Services as quickly
        ...
        <p>
          ...
          of Canada. NSCC Poop Logger and yourself irrevocably consent that the
        ...
        <p>
          ...
          Halifax, Canada. The language of the proceedings shall be English. The
        ...
        <p>
            ...
            at:
            <li>NSCC Poop Logger</li>
            <li>5685 Leeds St</li>
            <li>Halifax, Nova Scotia B3K 4M2</li>
            <li>Canada</li>
            <li>Phone: +9024035575</li>
            <li>Email: w0455841@nscc.ca</li>
            <li>
