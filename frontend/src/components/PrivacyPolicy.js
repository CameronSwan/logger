...
const PrivacyPolicy = () => {
    ...
    return (
        <div className='outside-spacing'>
            <h1 className='underlined'>Privacy Policy</h1>
            ...
            <ul>
                ...
                <li><strong>Application </strong>
                    refers to Poop Logger, the software program provided by the Company.
                </li>
                <li><strong>Company </strong>
                    (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Poop Logger.
                </li>
                <li><strong>Country </strong>
                    refers to: Nova Scotia, Canada
                </li>
                ...
                <li><strong>Service Provider </strong>
                    means any natural or legal person who processes the data on behalf of the Company.<br />
            ...
            <p>
                ...
                unique device identifiers and other diagnostic data. When You access the Service by
                or through a mobile device, We may collect certain information automatically, including,
            ...
            <p>
                ...
                than those from Your jurisdiction. Your consent to this Privacy Policy followed by Your submission
                of such information represents Your agreement to that transfer. The Company will take all steps reasonably
            ...
            <p>
                ...
                at any time by signing in to your Account, if you have one, and visiting the account settings section
